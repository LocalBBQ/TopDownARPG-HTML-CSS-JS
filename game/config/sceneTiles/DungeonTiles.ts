...
export const SceneTilesDungeon: Record<string, { width: number; height: number; obstacles?: unknown[]; perimeterWall?: unknown; spawn?: { type: string; count?: number }; [key: string]: unknown }> = {
  ...
  /** Ogre den interior: cave lair, pillars and braziers, scattered rocks, no pack spawn (boss only). Cave exit is spawned on the perimeter when the ogre is killed. */
  ogreDenInterior: {
    width: 1200,
    height: 1200,
    obstacles: [
      { type: 'column', x: 280, y: 320, width: 50, height: 50 },
      { type: 'column', x: 868, y: 318, width: 50, height: 50 },
      { type: 'column', x: 280, y: 830, width: 50, height: 50 },
      { type: 'column', x: 868, y: 828, width: 50, height: 50 },
      { type: 'brazier', x: 520, y: 340, width: 46, height: 46 },
      { type: 'brazier', x: 634, y: 340, width: 44, height: 44 },
      { type: 'brazier', x: 520, y: 808, width: 46, height: 46 },
      { type: 'brazier', x: 634, y: 808, width: 44, height: 44 },
      { type: 'rubble', x: 400, y: 560, width: 52, height: 52 },
      { type: 'rubble', x: 748, y: 580, width: 48, height: 48 },
      { type: 'stoneDebris', x: 540, y: 520, width: 42, height: 42 },
      { type: 'rock', x: 160, y: 200, width: 58, height: 52 },
      { type: 'rock', x: 980, y: 180, width: 62, height: 55 },
      { type: 'rock', x: 140, y: 920, width: 55, height: 50 },
      { type: 'rock', x: 1000, y: 940, width: 60, height: 58 },
      { type: 'rock', x: 380, y: 620, width: 70, height: 70 },
      { type: 'rock', x: 750, y: 640, width: 65, height: 65 },
      { type: 'rock', x: 320, y: 480, width: 48, height: 45 },
      { type: 'rock', x: 820, y: 500, width: 52, height: 48 },
      { type: 'rock', x: 480, y: 720, width: 56, height: 54 },
      { type: 'rock', x: 680, y: 380, width: 50, height: 46 },
      { type: 'rock', x: 200, y: 580, width: 54, height: 50 },
      { type: 'rock', x: 920, y: 760, width: 58, height: 52 },
    ],
  },
};
